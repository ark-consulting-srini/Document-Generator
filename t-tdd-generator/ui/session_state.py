"""
Session State Management for T - TDD Generator
...
def init_session_state():
    ...
    if 'target_platform' not in st.session_state:
        st.session_state.target_platform = 'databricks'
    ...
    # dbt Generator
    if 'dbt_generator_results' not in st.session_state:
        st.session_state.dbt_generator_results = {}
    if 'dbt_raw_source_name' not in st.session_state:
        st.session_state.dbt_raw_source_name = 'raw'
